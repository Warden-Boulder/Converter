...
function toCm() {
  let feet = document.getElementById("input").value || 0;
  let cm = feet*30.48
...
function toFt() {
  let cm = document.getElementById("input").value || 0;
  let feet = cm/30.48
...
function toMeter() {
  let yard = document.getElementById("input").value || 0;
...
function toYd() {
  let meter = document.getElementById("input").value || 0;
...
function toKm() {
  let mi = document.getElementById("input").value || 0;
  let km = mi*1.61
...
function toMi() {
  let km = document.getElementById("input").value || 0;
  let mi = km/1.61
